<div class="min-h-screen flex items-center justify-center bg-gray-100 p-4" x-data="passwordGenerator()">
    <div class="bg-white shadow-lg rounded-lg w-full max-w-md p-6 sm:p-8">
        ...
        <form class="space-y-5" wire:submit.prevent="store">
            ...
            <button type="submit"
                class="w-full text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-3 text-center transition duration-150">
                Crear Usuario
            </button>
        </form>
    </div>
